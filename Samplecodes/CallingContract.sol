...
contract CallingContract is ExternalStorage{
    ...
    // *** Delete Methods ***
     function deleteUint(address _balanceHolder) onlyOwner public {
        bytes32 _key = keccak256(abi.encodePacked("balances", _balanceHolder));
        delete uIntStorage[_key];
    }

    function deleteAddress(address _balanceHolder) onlyOwner public {
        bytes32 _key = keccak256(abi.encodePacked("balances", _balanceHolder));
        delete uIntStorage[_key];
    }
